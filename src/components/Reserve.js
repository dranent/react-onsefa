    ...
    return (
        ...
        <form ref={form} onSubmit={sendEmail} id='form-data' className='form-data'>
          ...
          <div className="form-privacy">
            ...
            <div className="form-privacy_inner scroll">
              <p>On Artmake 医院（以下「当クリニック」といいます。）は、お客様のプライバシー・個人情報（以下、個人情報と称します）を保護し、ご提供いただいた個人情報の取扱いについて、最大限の注意を払います。個人情報の利用には利用目的を特定し、特定された目的以外の利用はいたしません。</p>
              <dl>
                <dt>方針1</dt>
              ...
              <p>［お問い合わせ先］<br />On Artmake<br />電話：03-5579-9319　受付時間：水木金土日10:00～19:00</p>
            </div>
          </div>
          <div className="form-privacy">
            ...
            <div className="form-privacy_inner scroll">
              <p>ご予約のキャンセル及びご変更を希望される場合、3日前までに電話、メールにてご連絡をお願い致します。<br />
                当クリニックはキャンセル費は5,000円になります。施術当日10分以上遅れる場合はご連絡下さい。</p>
            </div>
          </div>
